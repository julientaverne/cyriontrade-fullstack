...
export default function PriceChart({ historicData, currency, days }) {
  ...
  const { chartRef, seriesRef, isReady, seriesVersion } = useLightweightChart({
    containerRef,
    chartType,
    data: normalizedData,
  });
  ...
  }, [chartRef, isReady, showSMA, smaData, seriesVersion]);
  ...
  }, [chartRef, isReady, showEMA, emaData, seriesVersion]);
